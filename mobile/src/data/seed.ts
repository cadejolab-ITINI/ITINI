...
export const seedDestinations: Destination[] = [
  {
    ...
    latitude: 13.0528, longitude: -86.3915, distanceKm: 5.2, durationMinutes: 90,
    ...
    routeCoordinates: [
      ...
      { latitude: 13.0643, longitude: -86.3822 }, { latitude: 13.0528, longitude: -86.3915 },
    ],
  ...
  },
  {
    ...
    latitude: 12.9968, longitude: -86.3718, distanceKm: 14.1, durationMinutes: 300,
    ...
    routeCoordinates: [
      ...
      { latitude: 13.025, longitude: -86.368 }, { latitude: 12.9968, longitude: -86.3718 },
    ],
    verificationStatus: 'demo', updatedAt: UPDATED_AT,
  },
  {
    ...
    latitude: 13.0108, longitude: -86.3669, distanceKm: 6.8, durationMinutes: 120,
    ...
    routeCoordinates: [
      ...
      { latitude: 13.0108, longitude: -86.3669 },
    ],
    verificationStatus: 'demo', updatedAt: UPDATED_AT,
  },
  {
    ...
    latitude: 12.9865, longitude: -86.3425, distanceKm: 12.5, durationMinutes: 240,
    ...
    routeCoordinates: [
      ...
      { latitude: 12.9865, longitude: -86.3425 },
    ],
    verificationStatus: 'demo', updatedAt: UPDATED_AT,
  },
  {
    ...
    latitude: 13.0324, longitude: -86.3981, distanceKm: 9.3, durationMinutes: 180,
    ...
    routeCoordinates: [
      ...
      { latitude: 13.0324, longitude: -86.3981 },
    ],
    verificationStatus: 'demo', updatedAt: UPDATED_AT,
  },
];
