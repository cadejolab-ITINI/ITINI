...
const styles = StyleSheet.create({
  ...
  gpsButton: { position: 'absolute', left: 20, bottom: 129, width: 44, height: 44, borderRadius: 22, borderWidth: 1, borderColor: '#2F5978', backgroundColor: '#0C2038', alignItems: 'center', justifyContent: 'center', ...shadow },
  routeSummary: { position: 'absolute', left: 18, right: 18, bottom: 99, padding: 12, borderRadius: 16, borderWidth: 1, borderColor: '#24455F', backgroundColor: '#07142DF5', flexDirection: 'row', alignItems: 'center', gap: 4 },
  ...
  locationError: { position: 'absolute', left: 18, right: 80, bottom: 101, borderRadius: 9, padding: 8, backgroundColor: 'rgba(7,16,36,0.94)' },
