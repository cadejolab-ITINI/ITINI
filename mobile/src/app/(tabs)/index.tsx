...
const styles = StyleSheet.create({
  ...
  gpsButton: { position: 'absolute', left: 20, bottom: 122, width: 44, height: 44, borderRadius: 22, borderWidth: 1, borderColor: '#2F5978', backgroundColor: '#0C2038', alignItems: 'center', justifyContent: 'center', ...shadow },
  ...
  locationError: { position: 'absolute', left: 18, right: 80, bottom: 94, borderRadius: 9, padding: 8, backgroundColor: 'rgba(7,16,36,0.94)' },
