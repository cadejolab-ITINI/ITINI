  ...
  return (
    <Tabs
      screenOptions={{
        ...
        tabBarStyle: { position: 'absolute', left: 12, right: 12, bottom: 31, height: 64, borderRadius: 22, borderWidth: 1, borderTopWidth: 1, borderColor: '#1B2A42', backgroundColor: 'rgba(3, 9, 26, 0.97)', paddingBottom: 7, paddingTop: 7, elevation: 12, shadowColor: '#000', shadowOpacity: 0.35, shadowRadius: 14, shadowOffset: { width: 0, height: 8 } },
